...
# Split data
# from sklearn.model_selection import train_test_split
# Split data training dan lainnya
df2_train, df2_unseen = train_test_split(df2, test_size=179/891, random_state=0, stratify=df2['Survived'])

# Split lagi antara validasi dan testing
df2_val, df2_test = train_test_split(df2_unseen, test_size=90/179, random_state=0, stratify=df2_unseen['Survived'])
